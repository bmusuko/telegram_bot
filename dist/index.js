...
bot.onText(/\/ig (.*)/, controllers_1.Controller.instagramController(bot, baseApi));
bot.onText(/\/igp (.*)/, controllers_1.Controller.instagramProfileController(bot, baseApi));
bot.onText(/\/dimg (.*)/, controllers_1.Controller.dimgController(bot, baseApi));
