...
const saveController = (bot, storage) => (msg) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    const chatId = msg.chat.id;
    const uuidv4 = uuid_1.default.v4;
    if ((msg.caption && msg.caption.toLowerCase().includes('save')) ||
        (msg.reply_to_message && ((_a = msg.text) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes('save')))) {
        let file_id;
        let mime_type = '';
        ...
        else if (((_b = msg.reply_to_message) === null || _b === void 0 ? void 0 : _b.photo) && msg.reply_to_message.photo[0]) {
            file_id =
                msg.reply_to_message.photo[msg.reply_to_message.photo.length - 1]
                    .file_id;
            mime_type = 'image/jpeg';
        }
        else if ((_c = msg.reply_to_message) === null || _c === void 0 ? void 0 : _c.document) {
            file_id = msg.reply_to_message.document.file_id;
            mime_type = msg.reply_to_message.document.mime_type;
        }
        else if ((_d = msg.reply_to_message) === null || _d === void 0 ? void 0 : _d.video) {
