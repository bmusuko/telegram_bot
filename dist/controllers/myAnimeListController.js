...
const myAnimeListController = (bot) => (msg) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        resp_arr.map((res) => {
            send.push({
                ...
                input_message_content: {
                    message_text: `<b>${res.title} (${res.start_date ? res.start_date.substring(0, 4) : '-'}) • ${res.type}</b>\n⭐️ ${res.score}\n\nEpisode(s) : <b>${res.episodes}</b>\n\nSynosis:\n${res.synopsis}\n\n<a href="${res.image_url}">&#8204;</a>`,
                    parse_mode: 'HTML',
                },
            });
        });
